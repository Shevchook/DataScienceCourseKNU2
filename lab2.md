...
# Подивитися структуру файлу
str(h5readAttributes("H-H1_LOSC_C00_4_V1-1187006834-4096.hdf5", "strain/Strain"))
List of 7
 $ Npoints : int 16777216
 $ Xlabel  : chr "GPS time"
 $ Xspacing: num 0.000244
 $ Xstart  : int 1187006834
 $ Xunits  : chr "second"
 $ Ylabel  : chr "Strain"
 $ Yunits  : chr ""
```
...
strain <- h5read("D:/R/R2/LAB2/H-H1_LOSC_C00_4_V1-1187006834-4096.hdf5","strain/Strain")
```
