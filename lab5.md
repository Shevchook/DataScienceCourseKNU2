...
ANSWER:
> head(data[1:5]) # Виведення частини df, щою влізло в рядок
...
ANSWER:
> head(SelectData[66:68]) # Виведення частини df, щою влізло в рядок
...
ANSWER:
> colnames(SelectData[,60:64]) # Виведення частини імен змінних, щою влізло в рядок
